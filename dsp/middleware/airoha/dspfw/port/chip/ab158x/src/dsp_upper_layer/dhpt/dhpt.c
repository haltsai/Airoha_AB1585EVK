...
#define NO_OF_HP_STREAM         (1 + NO_OF_HP_STREAM_FOR_MULTI_MIC_STREAM + NO_OF_HP_STREAM_FOR_GAMING_MODE_DONGLE + NO_OF_HP_STREAM_For_WIRED_AUDIO + NO_OF_HP_STREAM_FOR_ADVANCED_PASSTHROUGH + NO_OF_HP_STREAM_FOR_BLE_AUDIO_DONGLE + NO_OF_HP_STREAM_FOR_ULL_AUDIO_V2_DONGLE)
