...
extern void ecnr_post_ec_library_load(void);
extern void ecnr_post_ec_library_unload(void);
#endif
...
extern void lc3plus_codec_library_load(void);
extern void lc3plus_codec_library_unload(void);
#endif
