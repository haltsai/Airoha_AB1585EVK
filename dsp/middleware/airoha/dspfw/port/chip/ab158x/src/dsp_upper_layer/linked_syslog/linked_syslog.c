...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_1[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Full Adapt ANC]Initialize ANC_PARA(%d)(%d), debug mode(%d)";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_5[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Full Adapt ANC]process, on_schedule(%d), out_of_schedule(%d), Lib_state(%d), over(%d), status[%d][%d]";
