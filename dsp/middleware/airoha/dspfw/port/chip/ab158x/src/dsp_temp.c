...
void Audio_Setup(void)
{
    ...
    extern void dsp_dchs_mcu2dsp_msg_sync_callback(hal_ccni_message_t msg, hal_ccni_message_t *ack);
    aud_msg_rx_register_callback(MSG_DSP2MCU_DCHS_COSYS_SYNC, dsp_dchs_mcu2dsp_msg_sync_callback, 1);
#endif
