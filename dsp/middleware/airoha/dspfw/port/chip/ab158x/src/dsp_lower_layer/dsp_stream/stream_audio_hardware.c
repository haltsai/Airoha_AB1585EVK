...
#if defined (AIR_WIRED_AUDIO_ENABLE) || defined (AIR_ADVANCED_PASSTHROUGH_ENABLE) || defined (AIR_DUAL_CHIP_MIXING_MODE_ROLE_MASTER_ENABLE) || defined (AIR_DUAL_CHIP_MIXING_MODE_ROLE_SLAVE_ENABLE)
...
VOID Sink_Audio_Get_Default_Parameters(SINK sink)
{
...
#endif
    {
        if (((media_frame_samples == 120) && ( pAudPara->rate == 16000))||((media_frame_samples == 240) && ( pAudPara->rate == 32000))||((media_frame_samples == 360) && ( pAudPara->rate == 48000))) {
            pAudPara->buffer_size   = (AUDIO_AFE_DL_DEFAULT_FRAME_NUM + 4) * media_frame_samples *
                              pAudPara->channel_num * pAudPara->format_bytes;
        }
        else {
            pAudPara->buffer_size   = AUDIO_AFE_DL_DEFAULT_FRAME_NUM * media_frame_samples * pAudPara->channel_num * pAudPara->format_bytes;
        }
    }
    ...
    output_port_parameters.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface;
#ifdef AIR_HFP_DNN_PATH_ENABLE
    ...
    if (pAudPara->audio_device & HAL_AUDIO_CONTROL_DEVICE_INTERNAL_DAC_DUAL) {
        ...
        device_handle->i2s_master.i2s_interface = (hal_audio_device_interface_t)gAudioCtrl.Afe.AfeDLSetting.audio_interface;
        if (device_handle->i2s_master.i2s_interface & HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1) {
        ...
        } else if (device_handle->i2s_master.i2s_interface & HAL_AUDIO_CONTROL_DEVICE_INTERFACE_2) {
        ...
        } else if (device_handle->i2s_master.i2s_interface & HAL_AUDIO_CONTROL_DEVICE_INTERFACE_3) {
        ...
        } else if (device_handle->i2s_master.i2s_interface & HAL_AUDIO_CONTROL_DEVICE_INTERFACE_4) {
        ...
        device_handle->i2s_slave.i2s_interface = (hal_audio_device_interface_t)gAudioCtrl.Afe.AfeDLSetting.audio_interface;
        ...
        DSP_MW_LOG_I("src_tracking_clock_source =  %d\r\n", 1, mem_handle->src_tracking_clock_source);
#endif
...
#endif
#ifdef AIR_AUDIO_SUPPORT_MULTIPLE_MICROPHONE
    pAudPara->audio_device_rate              = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate1             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate2             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate3             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate4             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate5             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate6             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
    pAudPara->audio_device_rate7             = gAudioCtrl.Afe.AfeULSetting.audio_path_input_rate;
#endif
#ifdef AIR_AUDIO_SUPPORT_MULTIPLE_MICROPHONE
...
//    path_handle->audio_path_output_rate = pAudPara->rate;//afe_get_audio_device_samplerate(pAudPara->audio_device, pAudPara->audio_interface);
    ...
    uint32_t i;
    hal_audio_path_port_parameter_t input_port_parameters, output_port_parameters;
    input_port_parameters.device_interface =(hal_audio_device_interface_t)pAudPara->audio_interface;
    ...
    hal_audio_device_interface_t device_interface[HAL_AUDIO_PATH_SUPPORT_SEQUENCE]= {
        (hal_audio_device_interface_t)pAudPara->audio_interface, (hal_audio_device_interface_t)pAudPara->audio_interface1, (hal_audio_device_interface_t)pAudPara->audio_interface2, (hal_audio_device_interface_t)pAudPara->audio_interface3
        #ifdef MTK_AUDIO_HW_IO_CONFIG_ENHANCE
        , (hal_audio_device_interface_t)pAudPara->audio_interface4, (hal_audio_device_interface_t)pAudPara->audio_interface5, (hal_audio_device_interface_t)pAudPara->audio_interface6, (hal_audio_device_interface_t)pAudPara->audio_interface7
        #endif /* MTK_AUDIO_HW_IO_CONFIG_ENHANCE */
    };
...

{
    ...
    */
    ...
    if ((pAudPara->audio_device) & (HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_DUAL | HAL_AUDIO_CONTROL_DEVICE_LINE_IN_DUAL | HAL_AUDIO_CONTROL_DEVICE_DIGITAL_MIC_DUAL | HAL_AUDIO_CONTROL_DEVICE_ANC | HAL_AUDIO_CONTROL_DEVICE_I2S_MASTER | HAL_AUDIO_CONTROL_DEVICE_I2S_MASTER_L | HAL_AUDIO_CONTROL_DEVICE_I2S_MASTER_R | HAL_AUDIO_CONTROL_DEVICE_I2S_SLAVE)) {
        ...
        device_handle->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface;
        ...
        device_handle1->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface1;
        ...
        device_handle2->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface2;
        ...
        device_handle3->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface3;
        ...
        device_handle4->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface4;
        ...
        device_handle5->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface5;
        ...
        device_handle6->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface6;
        ...
        device_handle7->common.device_interface = (hal_audio_device_interface_t)pAudPara->audio_interface7;
    ...
    if ((device_handle->common.audio_device)&HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_DUAL) {
        ...
        switch (device_handle->common.audio_device) {
            ...
            case HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_L:
                if (device_handle->common.device_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1) {
                    device_handle->analog_mic.adc_parameter.adc_mode = gAudioCtrl.Afe.AfeULSetting.ul_adc_mode[0];
                } else if (device_handle->common.device_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_2) {
                    device_handle->analog_mic.adc_parameter.adc_mode = gAudioCtrl.Afe.AfeULSetting.ul_adc_mode[2];
                } else if (device_handle->common.device_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_3) {
                    device_handle->analog_mic.adc_parameter.adc_mode = gAudioCtrl.Afe.AfeULSetting.ul_adc_mode[4];
                } else if (device_handle->common.device_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_4) {
