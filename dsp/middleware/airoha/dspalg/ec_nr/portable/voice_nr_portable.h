...
#if defined(AIR_VOICE_NR_USE_PIC_ENABLE)
typedef void (*p_NB_RX_NR_init)(void *p_ecnr_mem_ext, void *p_nr_NvKey, void *p_rxeq_NvKey);
typedef void (*p_Voice_NB_RX_Prcs)(S16 *NR);
typedef void (*p_WB_RX_NR_init)(void *p_ecnr_mem_ext, void *p_nr_NvKey, void *p_rxeq_NvKey);
typedef void (*p_Voice_WB_RX_Prcs)(S16 *NR);
typedef void (*p_SWB_RX_NR_init)(void *p_ecnr_mem_ext, void *p_nr_NvKey, void *p_ecnr_swb_NvKey, void *p_rxeq_NvKey);
...
typedef S16 (*p_PF_GAIN_FB_READBACK)(void);
/* EC */
typedef void (*p_Voice_EC_Init)(int NB_mode, void *p_ecnr_mem_ext, void *p_aec_NvKey, void *p_nr_NvKey, void *p_inear_NvKey, S16 *NR_gain);
typedef void (*p_Voice_EC_Prcs)(S16 *MIC1, S16 *MIC2, S16 *Ref, S16 *EC_out1, S16 *EC_out2);
typedef void (*p_Voice_EC_Inear_Init)(int NB_mode, void *p_ecnr_mem_ext, void *p_aec_NvKey, void *p_nr_NvKey, void *p_inear_NvKey, S16 *NR_gain);
typedef void (*p_Voice_EC_Inear_Prcs)(S16 *MIC1, S16 *MIC2, S16 *MICB, S16 *REF, S16 *EC_out1, S16 *EC_out2, S16 *EC_outB);
typedef void (*p_Voice_SWB_EC_Init)(void *p_ecnr_mem_ext, void *p_aec_NvKey, void *p_nr_NvKey, void *p_inear_NvKey, void *p_ecnr_swb_NvKey);
typedef void (*p_Voice_SWB_EC_Prcs)(S16 *MIC1, S16 *MIC2, S16 *REF, S16 *EC_out1, S16 *EC_out2);
typedef void (*p_Voice_SWB_EC_Inear_Init)(void *p_ecnr_mem_ext, void *p_aec_NvKey, void *p_nr_NvKey, void *p_inear_NvKey, void *p_ecnr_swb_NvKey);
...
#define get_ec120_memsize          ((p_get_ec120_memsize)g_ecnr_prev_decoder_export_parameters[0])
#define Voice_EC120_Init           ((p_Voice_EC120_Init)g_ecnr_prev_decoder_export_parameters[1])
#define Voice_EC120_Prcs           ((p_Voice_EC120_Prcs)g_ecnr_prev_decoder_export_parameters[2])
#define Voice_PostEC120_Prcs       ((p_Voice_PostEC120_Prcs)g_ecnr_prev_decoder_export_parameters[3])
#define EC120_REF_GAIN_READBACK    ((p_EC120_REF_GAIN_READBACK)g_ecnr_prev_decoder_export_parameters[4])
#define get_EC120_SVN              ((p_get_EC120_SVN)g_ecnr_prev_decoder_export_parameters[5])
#define get_ec120_inear_memsize    ((p_get_ec120_inear_memsize)g_ecnr_prev_decoder_export_parameters[6])
#define Voice_EC120_Inear_Init     ((p_Voice_EC120_Inear_Init)g_ecnr_prev_decoder_export_parameters[7])
#define Voice_EC120_Inear_Prcs     ((p_Voice_EC120_Inear_Prcs)g_ecnr_prev_decoder_export_parameters[8])
#define EC120_Inear_REF_GAIN_READBACK ((p_EC120_Inear_REF_GAIN_READBACK)g_ecnr_prev_decoder_export_parameters[9])
#define EC120_PreLim_Coef_READBACK    ((p_EC120_PreLim_Coef_READBACK)g_ecnr_prev_decoder_export_parameters[10])
#define EC120_DaulMIC_power_Coef_READBACK ((p_EC120_DaulMIC_power_Coef_READBACK)g_ecnr_prev_decoder_export_parameters[11])
#define PostEC120_Info             ((p_PostEC120_Info)g_ecnr_prev_decoder_export_parameters[12])
...
void EC120_REF_GAIN_READBACK(S16 *gain);
int get_EC120_SVN(void);
...
void EC120_Inear_REF_GAIN_READBACK(S16 *gain);
void EC120_PreLim_Coef_READBACK(S16 *coef);
S16 EC120_DaulMIC_power_Coef_READBACK(void);
