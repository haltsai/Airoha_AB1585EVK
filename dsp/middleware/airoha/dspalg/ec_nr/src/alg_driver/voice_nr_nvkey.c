...
static void HPF_COEF_ASSIGN(S32 *coef, S32 *tab, int sw)
{
...
void voice_nvkey_aec_nr_porting_layer(void *p_nvkey_aec, void *p_nvkey_nr, void *p_nvkey_inear, void *p_nvkey_aec_nr)
{
    ...
    //HPF COEF
    HPF_COEF_ASSIGN((S32 *)&all->VOICE_TX_HP_COEF_0, (S32 *)HPF_4K_COEF_PL, HPF_sw);
    HPF_COEF_ASSIGN((S32 *)&all->VOICE_WB_RX_HP_COEF_0, (S32 *)HPF_16K_COEF_PL, HPF_sw);
    HPF_COEF_ASSIGN((S32 *)&all->VOICE_NB_RX_HP_COEF_0, (S32 *)HPF_8K_COEF_PL, HPF_sw);
    HPF_COEF_ASSIGN((S32 *)&all->VOICE_IE_HP_COEF_0, (S32 *)HPF_16K_COEF_PL, HPF_sw);
}
