...
HWVAD_STA hwvad_init(hwvad_config_t config)
{
    ...
    hwvad_vow_control.mic_interface = (hal_audio_device_interface_t)config.hwvad_vow_para.main_interface;
    hwvad_vow_control.mic1_selection = (hal_audio_control_t)config.hwvad_vow_para.ref_mic;
    hwvad_vow_control.mic1_interface = (hal_audio_device_interface_t)config.hwvad_vow_para.ref_interface;
    ...
    //hwvad_vow_control.mic_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
