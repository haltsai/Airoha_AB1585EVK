...
00000000 <_init-0xb8>:
  ...
  60:	00001330 0000019c 00000d70 000002e0     0.......p.......
  70:	00000dec 00001300 ffff8000 00007fff     ................
...
00000128 <_start>:
 ...
 140:	ffbcb1                                    	l32r	a11, 30 (418 <_CVSD_Decoder_Init>)
 143:	0008e0                                    	callx8	a8
 146:	0388                                    	l32i.n	a8, a3, 0
 148:	ffbba1                                    	l32r	a10, 34 (1284 <_DYNAMIC+0x3b0>)
 14b:	ffbbb1                                    	l32r	a11, 38 (450 <_CVSD_Decoder>)
...
00000418 <_CVSD_Decoder_Init>:
 418:	004136                                    	entry	a1, 32
 41b:	3a02d24018810c8e                  	{ movi	a8, 60; addmi	a10, a2, 0x700 }
 423:	725a82                                    	s16i	a8, a10, 228
 426:	051366                                    	bnei	a3, 1, 42f <_CVSD_Decoder_Init+0x17>
 429:	78a092                                    	movi	a9, 120
 42c:	725a92                                    	s16i	a9, a10, 228

0000042f <_CVSD_Decoder_Init+0x17>:
 42f:	ff0d81                                    	l32r	a8, 64 (19c <cvsd_decode_init>)
 432:	2206f242046a02be                  	{ addi	a11, a2, 8; or	a10, a2, a2 }
 43a:	0008e0                                    	callx8	a8
 43d:	ff0a81                                    	l32r	a8, 68 (d70 <cvsd_src_dn_sampling_init>)
 440:	0a02e245046102be                  	{ addi	a11, a2, 20; addi	a10, a2, 4 }
 448:	0008e0                                    	callx8	a8
 44b:	f01d                                    	retw.n

0000044d <_CVSD_Decoder_Init+0x35>:
 44d:	000000                                        ...

00000450 <_CVSD_Decoder>:
 450:	006136                                    	entry	a1, 48
 453:	03bd                                    	mov.n	a11, a3
 455:	0b03e2411c60023e                  	{ addmi	a3, a2, 0x700; l32i	a10, a2, 0 }
 45d:	00069144108b739e                  	{ l16si	a9, a3, 228; or	a12, a1, a1 }
 465:	0f02e1440401e18e                  	{ l32r	a8, 6c (2e0 <cvsd_decode_process>); addi	a14, a1, 4 }
 46d:	0202e3c1047a725e                  	{ addi	a5, a2, 100; addi	a3, a3, -24 }
 475:	1d06a9400086019e                  	{ s32i	a9, a1, 0; slli	a9, a9, 4 }
 47d:	1506b540088b119e                  	{ s32i	a9, a1, 4; or	a13, a5, a5 }
 485:	0008e0                                    	callx8	a8
 488:	7e93d2                                    	l16si	a13, a3, 252
 48b:	fef981                                    	l32r	a8, 70 (dec <cvsd_src_dn_sampling_process>)
 48e:	3406b54700eaf44e                  	{ or	a12, a4, a4; or	a11, a5, a5 }
 496:	1b03a24708a00dce                  	{ slli	a13, a13, 4; l32i	a10, a2, 4 }
 49e:	0008e0                                    	callx8	a8
 4a1:	7e9322                                    	l16si	a2, a3, 252
 4a4:	1122f0                                    	slli	a2, a2, 1
 4a7:	f01d                                    	retw.n

000004a9 <_CVSD_Decoder+0x59>:
 4a9:	00000000 36000000                                .......
