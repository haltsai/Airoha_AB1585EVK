...
#define ANC_FULL_ADAPT_STATE_FREEZE      (2)
...
dsp_anc_control_result_t dsp_anc_control_set_ramp_capability(uint32_t filter_mask, int16_t gain_value, uint8_t ramp_delay, uint8_t down_step, uint8_t up_step, dsp_anc_control_misc_t *control_misc);
