...
#ifdef AIR_AI_NR_PREMIUM_ENABLE

#define IGO_NR_MEMSIZE (24 * 1024)

typedef void (*p_IGO_NR_Init)(void *DRAM_work, uint32_t *nvkey_nr_para);
...
typedef void (*p_IGO_NR_Prcs)(int16_t* FF_out, int16_t* FB_out, int16_t* ref, int16_t* NR_out, uint32_t *nvkey_nr_para, uint8_t switch_mode, uint8_t nr_level, uint32_t gain, void *DRAM_work);
