...
void sidetone_in_device_para(hal_audio_device_parameter_t *device_handle_in, afe_sidetone_param_t *param)
{
    ...
    if ((device_handle_in->common.audio_device)&HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_DUAL) {
        device_handle_in->analog_mic.mic_interface = (hal_audio_device_interface_t)param->in_interface;
        ...
        device_handle_in->digital_mic.mic_interface = (hal_audio_device_interface_t)param->in_interface;
        ...
        device_handle_in->i2s_master.i2s_interface = (hal_audio_device_interface_t)param->in_interface;
        ...
        device_handle_in->i2s_slave.i2s_interface = (hal_audio_device_interface_t)param->in_interface;
        ...
        input_port_parameters.device_interface = (hal_audio_device_interface_t)param->in_interface;
        ...
        device_handle_in->sidetone.input_interface = (hal_audio_device_interface_t)param->in_interface;
        device_handle_in->sidetone.output_device = param->out_device;
        device_handle_in->sidetone.output_interface = (hal_audio_device_interface_t)param->out_interface;
        ...
        device_handle_in->sidetone.p_sidetone_FIR_coef = (uint16_t *)hal_memview_cm4_to_dsp0(param->FIR_nvdm_param);
...
void afe_set_sidetone_enable(bool enable, afe_sidetone_param_t *param, afe_sidetone_param_extension_t *extension_param, bool sidetone_rampdown_done_flag)
{
    ...
    if (enable) {
        ...
        if ((device_handle_out->common.audio_device) & HAL_AUDIO_CONTROL_DEVICE_INTERNAL_DAC_DUAL) {
            ...
            device_handle_out->i2s_master.i2s_interface = (hal_audio_device_interface_t)param->out_interface;//HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
            ...
            device_handle_out->i2s_slave.i2s_interface = (hal_audio_device_interface_t)param->out_interface;//HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
            ...
            device_handle_out->spdif.i2s_setting.i2s_interface = (hal_audio_device_interface_t)param->out_interface;//HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
...
void afe_set_loopback_enable(bool enable, afe_loopback_param_p param)
{
    ...
    if (enable) {
        ...
        input_port_parameters.device_interface = (hal_audio_device_interface_t)param->in_interface;
        output_port_parameters.device_interface = (hal_audio_device_interface_t)param->out_interface;
        ...
        if ((param->in_device)&HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_DUAL) {
            ...
            device_handle_in->i2s_slave.i2s_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
            device_handle_in->i2s_slave.i2s_format = HAL_AUDIO_I2S_I2S;
...
//#endif
...
#ifdef  LINE_IN_PURE_FOR_AMIC_CLASS_G_HQA
            device_handle_out->i2s_master.i2s_interface = (hal_audio_device_interface_t)param->out_interface;
#else
            device_handle_out->i2s_master.i2s_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
#endif
            device_handle_out->i2s_master.i2s_format = HAL_AUDIO_I2S_I2S;
            ...
            device_handle_out->i2s_slave.i2s_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
            device_handle_out->i2s_slave.i2s_format = HAL_AUDIO_I2S_I2S;
            ...
            device_handle_out->spdif.i2s_setting.i2s_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
            device_handle_out->spdif.i2s_setting.i2s_format = HAL_AUDIO_I2S_I2S;
...
#ifdef  LINE_IN_PURE_FOR_AMIC_CLASS_G_HQA
        if (param->in_device & HAL_AUDIO_CONTROL_DEVICE_ANALOG_MIC_DUAL) {
            if (device_handle_in->analog_mic.mic_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1) { //ADC01
                afe_volume_analog_set_gain_by_value(AFE_HW_ANALOG_GAIN_INPUT1, 0, 0); //AFE_VOLUME_ANALOG_INPUT_GAIN_ACC10K_POS_12_DB = 4
            } else if (device_handle_in->analog_mic.mic_interface == HAL_AUDIO_CONTROL_DEVICE_INTERFACE_2) { //ADC23
