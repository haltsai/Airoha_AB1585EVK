...
void hal_audio_set_stream_in_volume_for_multiple_microphone(uint16_t volume_index0, uint16_t volume_index1, hal_audio_input_gain_select_t gain_select)
{
    ...
    if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D0_D1) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC0_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC0_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D2_D3) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC1_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC1_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D4_D5) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC2_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_MIC2_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D6_D7) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S0_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S0_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D8_D9) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S1_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S1_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_D10_D11) {
        if (volume_index0 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S2_L] = (int32_t)((int16_t)volume_index0);
        }
        if (volume_index1 != HAL_AUDIO_INVALID_DIGITAL_GAIN_INDEX) {
            afe.stream_in.digital_gain_index[INPUT_DIGITAL_GAIN_FOR_I2S2_R] = (int32_t)((int16_t)volume_index1);
        }
    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_A0_A1) {
        if (volume_index0 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC0_L] = (int32_t)((int16_t)volume_index0);
            analog_input_gain.value_l = volume_index0;
        }
        if (volume_index1 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC0_R] = (int32_t)((int16_t)volume_index1);
            analog_input_gain.value_r = volume_index1;
        }
        analog_input_gain.device_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_1;
        ...
        if (volume_index0 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC1_L] = (int32_t)((int16_t)volume_index0);
            analog_input_gain.value_l = volume_index0;
        }
        if (volume_index1 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC1_R] = (int32_t)((int16_t)volume_index1);
            analog_input_gain.value_r = volume_index1;
        }
        analog_input_gain.device_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_2;
        hal_audio_set_value((hal_audio_set_value_parameter_t *)&analog_input_gain, HAL_AUDIO_SET_VOLUME_INPUT_ANALOG_GAIN);

    } else if (gain_select == HAL_AUDIO_INPUT_GAIN_SELECTION_A4_A5) {
        if (volume_index0 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC2_L] = (int32_t)((int16_t)volume_index0);
            analog_input_gain.value_l = volume_index0;
        }
        if (volume_index1 != HAL_AUDIO_INVALID_ANALOG_GAIN_INDEX) {
            afe.stream_in.analog_gain_index[INPUT_ANALOG_GAIN_FOR_MIC2_R] = (int32_t)((int16_t)volume_index1);
            analog_input_gain.value_r = volume_index1;
        }
        analog_input_gain.device_interface = HAL_AUDIO_CONTROL_DEVICE_INTERFACE_3;
        hal_audio_set_value((hal_audio_set_value_parameter_t *)&analog_input_gain, HAL_AUDIO_SET_VOLUME_INPUT_ANALOG_GAIN);
    }
