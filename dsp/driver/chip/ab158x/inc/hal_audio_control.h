...
typedef enum {
    ...
    HAL_AUDIO_AGENT_BLOCK_UP_SAMPLE23               = 15,
    HAL_AUDIO_AGENT_BLOCK_UP_SAMPLE23_CONFIGURE     = 16,
    HAL_AUDIO_AGENT_BLOCK_DOWN_SAMPLE01             = 17,
    HAL_AUDIO_AGENT_BLOCK_DOWN_SAMPLE23             = 18,
    HAL_AUDIO_AGENT_BLOCK_DOWN_SAMPLE23_CONFIGURE   = 19,
    HAL_AUDIO_AGENT_BLOCK_UPDN_MAX                  = HAL_AUDIO_AGENT_BLOCK_DOWN_SAMPLE23,

    /* device interfrace */
    HAL_AUDIO_AGENT_DEVICE_MIN                      = 20,
    ...
    HAL_AUDIO_AGENT_DEVICE_I2S1_SLAVE_TX            = 21,
    HAL_AUDIO_AGENT_DEVICE_I2S2_SLAVE_TX            = 22,
    HAL_AUDIO_AGENT_DEVICE_I2S0_SLAVE_RX            = 23,
    HAL_AUDIO_AGENT_DEVICE_I2S1_SLAVE_RX            = 24,
    HAL_AUDIO_AGENT_DEVICE_I2S2_SLAVE_RX            = 25,
    HAL_AUDIO_AGENT_DEVICE_I2S_SLAVE_MAX            = HAL_AUDIO_AGENT_DEVICE_I2S2_SLAVE_RX,

    HAL_AUDIO_AGENT_DEVICE_I2S_MASTER_MIN           = 26,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_DUAL_TX      = HAL_AUDIO_AGENT_DEVICE_I2S_MASTER_MIN,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_DUAL_TX      = 27,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_DUAL_TX      = 28,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_DUAL_TX      = 29,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_L_TX         = 30,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_L_TX         = 31,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_L_TX         = 32,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_L_TX         = 33,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_R_TX         = 34,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_R_TX         = 35,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_R_TX         = 36,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_R_TX         = 37,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_DUAL_RX      = 38,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_DUAL_RX      = 39,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_DUAL_RX      = 40,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_DUAL_RX      = 41,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_L_RX         = 42,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_L_RX         = 43,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_L_RX         = 44,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_L_RX         = 45,
    HAL_AUDIO_AGENT_DEVICE_I2S0_MASTER_R_RX         = 46,
    HAL_AUDIO_AGENT_DEVICE_I2S1_MASTER_R_RX         = 47,
    HAL_AUDIO_AGENT_DEVICE_I2S2_MASTER_R_RX         = 48,
    HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_R_RX         = 49,
    HAL_AUDIO_AGENT_DEVICE_I2S_MASTER_MAX           = HAL_AUDIO_AGENT_DEVICE_I2S3_MASTER_R_RX,

    HAL_AUDIO_AGENT_DEVICE_ADDA_MIN                 = 50,
    HAL_AUDIO_AGENT_DEVICE_ADDA_DL1                 = HAL_AUDIO_AGENT_DEVICE_ADDA_MIN,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL1_DUAL            = 51,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL2_DUAL            = 52,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL3_DUAL            = 53,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL4_DUAL            = 54,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL1_L               = 55,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL2_L               = 56,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL3_L               = 57,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL4_L               = 58,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL1_R               = 59,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL2_R               = 60,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL3_R               = 61,
    HAL_AUDIO_AGENT_DEVICE_ADDA_UL4_R               = 62,
    HAL_AUDIO_AGENT_DEVICE_ADDA_MAX                 = HAL_AUDIO_AGENT_DEVICE_ADDA_UL4_R,

    HAL_AUDIO_AGENT_DEVICE_SIDETONE                 = 63,
    HAL_AUDIO_AGENT_DEVICE_ANC                      = 64,
    HAL_AUDIO_AGENT_DEVICE_VAD                      = 65,
    HAL_AUDIO_AGENT_DEVICE_VOW                      = 66,
    HAL_AUDIO_AGENT_DEVICE_MAX                      = HAL_AUDIO_AGENT_DEVICE_VOW,

    HAL_AUDIO_AGENT_DEVICE_INPUT                    = 67,
    HAL_AUDIO_AGENT_DEVICE_OUTPUT                   = 68,
    HAL_AUDIO_AGENT_DEVICE_TDM_RX                   = 69,
    HAL_AUDIO_AGENT_DEVICE_TDM_TX                   = 70,

    HAL_AUDIO_AGENT_NUMBERS                         = 71,
...
typedef enum {
    ...
    HAL_AUDIO_DEVICE_AGENT_DEVICE_I2S_SLAVE_MIN            = HAL_AUDIO_AGENT_DEVICE_MIN,
    HAL_AUDIO_DEVICE_AGENT_DEVICE_I2S0_SLAVE               = HAL_AUDIO_AGENT_DEVICE_I2S_SLAVE_MIN,
    HAL_AUDIO_DEVICE_AGENT_DEVICE_I2S1_SLAV                = 1,
    ...
    HAL_AUDIO_DEVICE_AGENT_DEVICE_I2S0_MASTER              = HAL_AUDIO_AGENT_DEVICE_I2S_MASTER_MIN,
    ...
    HAL_AUDIO_DEVICE_AGENT_DEVICE_ADDA_DL1                 = HAL_AUDIO_AGENT_DEVICE_ADDA_MIN,
    ...
    HAL_AUDIO_DEVICE_AGENT_DEVICE_MAX                      = HAL_AUDIO_AGENT_DEVICE_VOW,
...
typedef enum  {
    HAL_AUDIO_COMPONENT_MIN                      = 0,
    HAL_AUDIO_COMPONENT_A2DP                     = HAL_AUDIO_COMPONENT_MIN,
    HAL_AUDIO_COMPONENT_HFP_UL                   = 1,
    HAL_AUDIO_COMPONENT_HFP_DL                   = 2,
    HAL_AUDIO_COMPONENT_VP                       = 3,
    HAL_AUDIO_COMPONENT_LE_CALL_UL               = 4,
    HAL_AUDIO_COMPONENT_LE_CALL_DL               = 5,
    HAL_AUDIO_COMPONENT_LE_MUSIC_DL              = 6,
    HAL_AUDIO_COMPONENT_MULTI_MIC                = 7,
    HAL_AUDIO_COMPONENT_ESA                      = 8,
    HAL_AUDIO_COMPONENT_WWE                      = 9,
    HAL_AUDIO_COMPONENT_TDM                      = 10,

    HAL_AUDIO_COMPONENT_NO_USE                   = 0xFF,
} hal_audio_component_type_t;

typedef struct {
    hal_audio_component_type_t component_type;
