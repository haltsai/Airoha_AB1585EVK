...
enum {
    ...
    I2C_HW_STATE_USED_NORMAL,
    I2C_HW_STATE_USED_NB
};

enum {
    I2C_HW_STATE_IO_OPENDRAIN = 0,
    I2C_HW_STATE_IO_PUSHPULL,
};
...
typedef struct {
    ...
    hal_i2c_callback_t call_back;
    void    *user_data;
    i2c_transfer_config_t cfg_item[MAX_FIFO_SIZE];
}i2c_private_info_t;
#endif
...
int     queue_get_data_by_index(airo_queue_t  *pQueue, int index);
int     queue_get_empty_index(airo_queue_t  *pQueue);
int     queue_get_status(airo_queue_t  *pQueue);
/////////////////////////////////////////////////////////////////////////////
