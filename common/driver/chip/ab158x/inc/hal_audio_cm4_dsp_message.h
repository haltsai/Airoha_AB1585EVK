...
typedef enum {
    ...
    MSG_MCU2DSP_COMMON_ANC_START = (MSG_MCU2DSP_COMMON_BASE + 0x43),
    MSG_MCU2DSP_COMMON_ANC_STOP = (MSG_MCU2DSP_COMMON_BASE + 0x44),
    MSG_MCU2DSP_COMMON_ANC_SET_VOLUME = (MSG_MCU2DSP_COMMON_BASE + 0x45),
    MSG_MCU2DSP_COMMON_ANC_SET_PARAM = (MSG_MCU2DSP_COMMON_BASE + 0x46),
    MSG_DSP2MCU_COMMON_ANC_START_DONE = (MSG_MCU2DSP_COMMON_BASE + 0x47),
    ...
    MSG_MCU2DSP_PROMPT_CONFIG = (MSG_MCU2DSP_PROMPT_BASE + 0x4),
    ...
    MSG_DSP2MCU_DCHS_COSYS_SYNC = (MSG_MCU2DSP_AUDIO_BASE + 0x9),
