...
###################################################
# Sources
C_FILES += kernel/service/syslog/portable/src/syslog_port.c
C_FILES += kernel/service/syslog/src/syslog_dump_buffer_flash.c
C_FILES += kernel/service/syslog/src/syslog_debug.c
...
#include $(SOURCE_DIR)/kernel/service_protected/syslog/GCC/module.mk
ifeq ($(AIR_BTA_IC_PREMIUM_G2),y)
LIBS += $(SOURCE_DIR)/prebuilt/system/chip/bta_ic_premium_g2/syslog/lib_syslog_mcu.a
else ifeq ($(AIR_BTA_IC_PREMIUM_G3),y)
LIBS += $(SOURCE_DIR)/prebuilt/system/chip/bta_ic_premium_g3/syslog/lib_syslog_mcu.a
endif
...
CFLAGS += -I$(SOURCE_DIR)/kernel/service/syslog/portable/inc
