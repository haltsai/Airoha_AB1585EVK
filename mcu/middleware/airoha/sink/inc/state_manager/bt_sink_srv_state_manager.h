...
#define BT_SINK_SRV_STATE_MANAGER_DEVICE_TYPE_INVALID       0x00
#define BT_SINK_SRV_STATE_MANAGER_DEVICE_TYPE_EDR           0x01
#define BT_SINK_SRV_STATE_MANAGER_DEVICE_TYPE_LE            0x02
