...
bt_status_t bt_sink_srv_le_call_action_handler(uint32_t action, void *param)
{
    ...
    switch (action) {
        ...
        case BT_SINK_SRV_ACTION_3WAY_RELEASE_ALL_HELD: {
            ...
            if (BLE_TBS_INVALID_CALL_INDEX != bt_le_audio_sink_call_check_state(g_call_active_handle.accept_handle, BLE_CCP_GTBS_INDEX, BLE_TBS_STATE_ACTIVE) ||
                BLE_TBS_INVALID_CALL_INDEX != bt_le_audio_sink_call_check_state(g_call_active_handle.accept_handle, BLE_CCP_GTBS_INDEX, BLE_TBS_STATE_INCOMING) ||
                BLE_TBS_INVALID_CALL_INDEX != bt_le_audio_sink_call_check_state(g_call_active_handle.accept_handle, BLE_CCP_GTBS_INDEX, BLE_TBS_STATE_REMOTELY_HELD) ||
                BLE_TBS_INVALID_CALL_INDEX != bt_le_audio_sink_call_check_state(g_call_active_handle.accept_handle, BLE_CCP_GTBS_INDEX, BLE_TBS_STATE_LOCALLY_HELD) ||
                BLE_TBS_INVALID_CALL_INDEX != bt_le_audio_sink_call_check_state(g_call_active_handle.accept_handle, BLE_CCP_GTBS_INDEX, BLE_TBS_STATE_LOCALLY_AND_REMOTELY_HELD)) {
        ...
        case BT_SINK_SRV_ACTION_CALL_SET_VOLUME: {
            bt_sink_srv_le_volume_vcp_send_action(g_call_active_handle.reject_handle, le_action, NULL);
            break;
        }
