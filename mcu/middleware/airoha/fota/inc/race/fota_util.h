...
#if (PRODUCT_VERSION != 3335 && !defined(AIR_BTA_IC_PREMIUM_G2) && !defined(AIR_BTA_IC_PREMIUM_G3)) || !defined(BL_FOTA_ENABLE) || defined(MTK_BOOTLOADER_USE_MBEDTLS)
#define FOTA_USE_MBEDTLS_ENABLE /* Enable FOTA to ues the mbedtls algorithms. */

#ifdef FOTA_USE_MBEDTLS_ENABLE
#if (PRODUCT_VERSION != 3335 && !defined(AIR_BTA_IC_PREMIUM_G2) && !defined(AIR_BTA_IC_PREMIUM_G3)) || !defined(BL_FOTA_ENABLE)
