...
#if defined(MTK_USB_AUDIO_V1_ENABLE) || defined(MTK_USB_AUDIO_HID_ENABLE) || defined(MTK_USB_XBOX_ENABLE) || defined(__USB_MASS_STORAGE_ENABLE__)
...
static void USB_Basic_Info_Init(void)
{
    ...
    LOG_MSGID_I(USB_RESOURCE, "USB_Basic_Info_Init USE_CLASS  =%d", 1, basicinfo.use_class_info);
    LOG_MSGID_I(USB_RESOURCE, "USB_Basic_Info_Init USE_PRODUCT=%d", 1, basicinfo.use_product_info);
    LOG_MSGID_I(USB_RESOURCE, "USB_Basic_Info_Init USE_POWER  =%d", 1, basicinfo.use_power_info);
