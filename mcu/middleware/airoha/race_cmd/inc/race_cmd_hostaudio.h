...
#define RACE_MMI_MODULE_AEQ_GROUP_ID        (21)
#define RACE_MMI_MODULE_AEQ_STATUS_ID       (22)
#define RACE_MMI_MODULE_AEQ_DETECT_STATUS_ID (23)
#define RACE_MMI_MODULE_AEQ_DETECT_STATUS   (24)
