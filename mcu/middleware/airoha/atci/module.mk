...
ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG), mt2811 mt2523 mt2533 ab155x am255x ag3335))
ATCMD_FILES += $(ATCI_SRC)/at_command/at_command_dvfs.c
...
ifeq ($(IC_CONFIG), $(filter $(IC_CONFIG), mt2811 mt2822 ab155x am255x ab156x))
...
ifeq ($(MTK_SECURITY_AT_COMMAND_ENABLE),y)
