...
#if (PRODUCT_VERSION == 2552 || PRODUCT_VERSION == 1552 || PRODUCT_VERSION == 2811 || AIR_BTA_IC_PREMIUM_G2 || AIR_BTA_IC_PREMIUM_G3)
...
#if defined(HAL_SECURITY_MODULE_ENABLED) && defined(MTK_SECURITY_AT_COMMAND_ENABLE) && (PRODUCT_VERSION == 2822)
