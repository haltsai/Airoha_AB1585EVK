...
AIR_ANC_FIT_DETECTION_SRC_A2DP = y
...
# This option is used to enable XiaoAi.
...
# This option is to configure trigger mode of XiaoAi.
# mode: TTT, TTT_HOTWORD, PTT_HOTWORD
#       TTT           : Tap to talk.
#       TTT_HOTWORD   : Tap to talk, hotword trigger.
#       PTT_HOTWORD   : Push to talk, hotword trigger.
# Dependency: AIR_XIAOAI_ENABLE must be enabled when this option is not set to none.
AIR_XIAOAI_TRIGGER_MODE = TTT
...
PRODUCT_CATEGORY = AB1585_Earbuds