...
ifeq ($(AIR_LINE_IN_DET_WITH_HIGH_LEVEL_ENABLE), y)
...
C_FILES += $(APPS_SRC)/app_le_audio/app_le_audio_adv_mgr.c
C_FILES += $(APPS_SRC)/app_le_audio/app_le_audio_conn_mgr.c
