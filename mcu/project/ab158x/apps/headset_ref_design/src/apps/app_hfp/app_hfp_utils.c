        ...
        case KEY_VOICE_UP: {
#ifdef AIR_LE_AUDIO_ENABLE
            {
                ...
                if (handle != BT_HANDLE_INVALID && app_le_audio_aird_client_is_support_hid_call(handle))
                {
                    ...
                    app_le_audio_aird_client_send_action(handle, APP_LE_AUDIO_AIRD_ACTION_SET_STREAMING_VOLUME_UP,
        ...
        case KEY_VOICE_DN: {
#ifdef AIR_LE_AUDIO_ENABLE
            {
                ...
                if (handle != BT_HANDLE_INVALID && app_le_audio_aird_client_is_support_hid_call(handle))
                {
                    ...
                    app_le_audio_aird_client_send_action(handle, APP_LE_AUDIO_AIRD_ACTION_SET_STREAMING_VOLUME_DOWN,
                                                         &param, sizeof(app_le_audio_aird_action_set_streaming_volume_t));
                    ret = true;
                    break;
                }
...
//                         voice_prompt_stop(curr_vp_index, VOICE_PROMPT_ID_INVALID, true);
//                     }
//                }
//
...
//    }
    ...
    APPS_LOG_MSGID_I(APP_HFP_UTILS",[RING_IND] set incoming call vp. ", 0);
...
//        //app_hfp_set_incoming_call_vp_sync_flag(APP_HFP_INCOMING_CALL_VP_SYNC_PLAY_FAIL);
//        vp.vp_index   = vp_index;
//        vp.control    = VOICE_PROMPT_CONTROL_LOCALRT;
//        vp.delay_time = vp_delay_time;
//        vp.callback   = app_hfp_incoming_call_vp_callback;
//        voice_prompt_stop(stop_vp_index, VOICE_PROMPT_ID_INVALID, false);
//        voice_prompt_play(&vp, NULL);
//    }
}
...
bool app_hfp_mute_mic(bool mute)
{
    ...
    bt_status = bt_sink_srv_le_volume_set_mute(BT_SINK_SRV_LE_STREAM_TYPE_IN, mute);
#endif
