                                  ...
                                  size_t data_len)
{
    ...
    switch(action) {
        ...
        case KEY_VOICE_UP: {                          //= 0x000A,  /**< Volume up. */
            ...
            bt_status_t bt_status  ;//= apps_aws_sync_event_send(EVENT_GROUP_UI_SHELL_KEY, BT_SINK_SRV_ACTION_VOLUME_UP);
        } break;
        ...
        case KEY_VOICE_DN: {                          //= 0x000B,  /**< Volume down. */
            ...
            bt_status_t bt_status ;//= apps_aws_sync_event_send(EVENT_GROUP_UI_SHELL_KEY, BT_SINK_SRV_ACTION_VOLUME_DOWN);
        } break;
