...
extern void pmu_config_lp(void);
#endif
#endif
/**
...
void system_init(void)
{
    ...
    *(volatile uint32_t *)0x42040B20 = 0xFFFFFFFF;
...
#ifdef MTK_USB_ENABLED
#if defined(AIR_BTA_IC_PREMIUM_G3) && defined(MTK_BATTERY_MANAGEMENT_ENABLE)
    ...
    LOG_I(common, "DUAL_CHIP_MIXING_MODE_ROLE [MASTER]");
#elif defined(AIR_DUAL_CHIP_MIXING_MODE_ROLE_SLAVE_ENABLE)
    LOG_I(common, "DUAL_CHIP_MIXING_MODE_ROLE [SLAVE]");
#else
    LOG_W(common, "DUAL_CHIP_MIXING_MODE_ROLE [NONE]");
#endif
