...
void sleep_management_register_suspend_ns_callback(sleep_management_backup_restore_module_t module, sleep_management_suspend_callback_t callback, void *data)
{
    if (module == SLEEP_BACKUP_RESTORE_USER) {
        if (suspend_user_register_count_ns < SLEEP_BACKUP_RESTORE_USER_CALLBACK_FUNC_MAX) {
            ...
            log_hal_msgid_error("[Sleep Management]register suspend ns callback function overflow\r\n", 0);
            assert(0);
        }
    } else {
...
void sleep_management_register_resume_ns_callback(sleep_management_backup_restore_module_t module, sleep_management_resume_callback_t callback, void *data)
{
    if (module == SLEEP_BACKUP_RESTORE_USER) {
        if (resume_user_register_count_ns < SLEEP_BACKUP_RESTORE_USER_CALLBACK_FUNC_MAX) {
            ...
            log_hal_msgid_error("[Sleep Management]register resume ns callback function overflow\r\n", 0);
            assert(0);
        }
    } else {
...
void sleep_management_register_resume_secure_callback(sleep_management_backup_restore_module_t module, sleep_management_resume_callback_t callback, void *data)
{
    if (module == SLEEP_BACKUP_RESTORE_USER) {
        if (resume_user_register_count_in_secure < SLEEP_BACKUP_RESTORE_USER_CALLBACK_FUNC_MAX) {
            ...
            log_hal_msgid_error("[Sleep Management]register secure resume callback function overflow\r\n", 0);
            assert(0);
        }
    } else {
        ...
        if (((wakeup_source >> i) & 0x01) == 0) {
            switch (i) {
                case 0  :
                    ...
                    break;
                case 1  :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : GPT_SEC\r\n", 0);
                    break;
                case 2  :
                ...
                case 17 :
                    ...
                    break;
                case 18 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : INFRA_SEC_VIO\r\n", 0);
                    break;
                case 19 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_GPT\r\n", 0);
                    break;
                case 20 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_BT_TIMER\r\n", 0);
                    break;
                case 21 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_AURX\r\n", 0);
                    break;
                case 22 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_AUTX\r\n", 0);
                    break;
                case 23 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_BT_INT\r\n", 0);
                    break;
                case 24 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : COLIASSYS_MBX_TX\r\n", 0);
                    break;
                case 25 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : COLIASSYS_MBX_RX\r\n", 0);
                    break;
                case 26 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : SYSRAM_DRAM\r\n", 0);
                    break;
                case 27 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : I3C0\r\n", 0);
                    break;
                case 28 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : I3C1\r\n", 0);
                    break;
                case 29 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : INFRA_BUS_ERR\r\n", 0);
                    break;
                case 30 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CONNSYS_BT_PLAYEN\r\n", 0);
                    break;
                case 31 :
...
void sleep_management_dump_eint_wakeup_source(uint32_t eint_num)
{
    ...
    printf("[Sleep Management]WAKEUP_SOURCE : EINT 0 to 31 = 0x%x\r\n", (unsigned int)eint_num0);
    printf("[Sleep Management]WAKEUP_SOURCE : EINT 32 to 63 = 0x%x\r\n", (unsigned int)eint_num1);
    printf("[Sleep Management]WAKEUP_SOURCE : EINT 64 = 0x%x\r\n", (unsigned int)eint_num2);
                ...
                if (i <= 57) {
                    ...
                    switch (i) {
                        ...
                        case 60 :
                            ...
                            break;
                        case 61 :
                            printf("[Sleep Management]EINT_RTC_EVENT\r\n");
                            break;
                        case 62 :
                            printf("[Sleep Management]EINT_USB\r\n");
                            break;
                        case 63 :
                            printf("[Sleep Management]EINT_PMU\r\n");
                            break;
                        default :
                            break;
                    }
    ...
    if (((eint_num2 >> 0) & 0x01) == 0x01) {
        printf("[Sleep Management]EINT_IRRX\r\n");
    }
}
#endif
