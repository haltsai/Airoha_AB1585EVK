    ...
    *(((hal_core_id_t *)HW_SYSRAM_PRIVATE_MEMORY_CORE_STATUS_START) + id) = HAL_CORE_INIT;
    ...
    switch (id) {
        ...
        case HAL_CORE_DSP0:
            ...
            /* Test Mode */
            /* 0x420C0208 bit[7:5]: 0x1=E1 0x2=E2 0x3=E3 */
            if ((((*(volatile uint32_t *)0x420C0208) & 0xE0) >> 5) <= 0x1) {
                *(volatile uint32_t *)0x42010604 = 0x00000000;
                *(volatile uint32_t *)0x42140210 = 0xC; // pwr_rst_b =1'b0
                *(volatile uint32_t *)0x422C0014 = 0x001C0019;
                *(volatile uint32_t *)0x422C0010 = reset_vector;
                *(volatile uint32_t *)0x42140210 = 0xD; // pwr_rst_b =1'b1
                *(volatile uint32_t *)0x422C0018 = 0x00000000;
            }
