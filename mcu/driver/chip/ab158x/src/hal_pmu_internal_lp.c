...
pmu_power_vcore_voltage_t pmu_lock_vcore_lp(pmu_power_stage_t mode, pmu_power_vcore_voltage_t vol, pmu_lock_parameter_t lock)
{
    ...
    if (old_index < vol_index) { /* rising */
        ...
        if (pmu_dynamic_debug) {
            log_hal_msgid_info("[PMU_PWR]vcore lock[%d], lock state[%d], pmu_switch_case[%d], pmu_lock_status[%d]", 4,
    ...
    if (pmu_dynamic_debug) {
        log_hal_msgid_info("[PMU_PWR]vcore lock[%d], lock state[%d], pmu_switch_case[%d]", 3, pmu_get_vcore_voltage_lp(), temp, pmu_switch_case);
        log_hal_msgid_info("[PMU_PWR]vcore lock, pmu_switch_case[%d], pmu_lock_status[%d]", 2, pmu_switch_case, pmu_lock_status);
    }
    return vol_index;
}
...
/*[VAUD18]*/
void pmu_set_vaud18_voltage_lp(pmu_vaud18_voltage_t oper)
{
    switch (oper) {
        case PMU_VAUD18_0P7_V:
            pmu_set_register_value_lp(VAUD18_VSEL_L_ADDR, VAUD18_VSEL_L_MASK, VAUD18_VSEL_L_SHIFT, 0x5);
            break;
        case PMU_VAUD18_0P8_V:
            pmu_set_register_value_lp(VAUD18_VSEL_L_ADDR, VAUD18_VSEL_L_MASK, VAUD18_VSEL_L_SHIFT, 0xF);
            break;
        case PMU_VAUD18_0P9_V:
            pmu_set_register_value_lp(VAUD18_VSEL_L_ADDR, VAUD18_VSEL_L_MASK, VAUD18_VSEL_L_SHIFT, 0x19);
            break;
        case PMU_VAUD18_1P2_V:
            pmu_set_register_value_lp(VAUD18_VSEL_M_ADDR, VAUD18_VSEL_M_MASK, VAUD18_VSEL_M_SHIFT, 0x37);
            break;
        case PMU_VAUD18_1P3_V:
            pmu_set_register_value_lp(VAUD18_VSEL_M_ADDR, VAUD18_VSEL_M_MASK, VAUD18_VSEL_M_SHIFT, 0x41);
            break;
        case PMU_VAUD18_1P77_V:
            pmu_set_register_value_lp(VAUD18_VSEL_H_ADDR, VAUD18_VSEL_H_MASK, VAUD18_VSEL_H_SHIFT, 0x70);
            if (audio_mode == PMU_CLASSD) {
                pmu_set_register_value_lp(VAUD18_VSEL_L_ADDR, VAUD18_VSEL_L_MASK, VAUD18_VSEL_L_SHIFT, 0x70);
            }
            break;
        case PMU_VAUD18_1P8_V:
            pmu_set_register_value_lp(VAUD18_VSEL_H_ADDR, VAUD18_VSEL_H_MASK, VAUD18_VSEL_H_SHIFT, 0x73);
            break;
    }
}
...
pmu_operate_status_t pmu_set_vaud18_vout_lp(pmu_vaud18_voltage_t lv, pmu_vaud18_voltage_t mv, pmu_vaud18_voltage_t hv)
{
    if ((lv >= PMU_VAUD18_1P2_V) || (mv >= PMU_VAUD18_1P77_V) || (mv <= PMU_VAUD18_0P9_V) || (hv <= PMU_VAUD18_1P3_V)) {
        log_hal_msgid_error("[PMU_AUDIO]VAUD18 vol input error", 0);
        return PMU_INVALID;
    }
...
void pmu_set_audio_mode_init(pmu_audio_mode_t mode)
{
    ...
    switch (mode) {
        ...
        case PMU_CLASSG3:
            pmu_set_vaud18_voltage_lp(vaud18_vsel_arr[0]);
            pmu_set_vaud18_voltage_lp(vaud18_vsel_arr[1]);
            pmu_set_vaud18_voltage_lp(vaud18_vsel_arr[2]);
            pmu_set_vaud18_ripple_lp(mode, ripple_vaud18_en);
            log_hal_msgid_info("[PMU_AUDIO]set_audio_mode, CLASS G3", 0);
            break;
        case PMU_CLASSD:
            pmu_set_vaud18_voltage_lp(PMU_VAUD18_1P77_V);
            pmu_set_vaud18_ripple_lp(mode, ripple_vaud18_en);
...
void pmu_init_lp(void)
{
    ...
    pmu_set_register_value_lp(0x00E, RG_FAST_BUFFER_ENB_MASK, 2, 1);
    ...
    pmu_set_register_value_lp(0x00C, RG_BGHP_SEL_MASK, 1, 9);
    ...
    pmu_set_register_value_lp(0x326, RG_I_LIM_TRIM_MASK, 4, 6);
    ...
    log_hal_msgid_info("[PMU_BASIC]pmu_init, rg_012[0x%X], rg_082[0x%X], rg_09A[0x%X], rg_324[0x%X], rg_606[0x%X], rg_608[0x%X]", 6,
        pmu_get_register_value_lp(0x012, 0xFFFF, 0), pmu_get_register_value_lp(0x082, 0xFFFF, 0),
...
void pmu_power_off_sequence_lp(pmu_power_stage_t stage)
{
    switch (stage) {
        case PMU_PWROFF:
            ...
            log_hal_msgid_info("[PMU_BASIC]power_off_sequence [OFF], rg_012[0x%X], rg_084[0x%X], rg_092[0x%X], rg_09A[0x%X], rg_608[0x%X], rg_60C[0x%X]", 6,
