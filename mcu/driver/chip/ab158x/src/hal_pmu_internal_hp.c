...
uint8_t pmu_dynamic_debug = 1;                                          /* FLAG : Enable/disable pmu lock log  */
...
const char *vaud18_vsel_str[8] = { "0.7V", "0.8V", "0.9V", "1.2V", "1.3V", "1.77V", "1.8V"};
...
pmu_power_vcore_voltage_t pmu_lock_vcore_hp(pmu_power_stage_t mode, pmu_power_vcore_voltage_t vol, pmu_lock_parameter_t lock)
{
    if (pmu_dynamic_debug) {
        log_hal_msgid_info("[PMU_BASIC][PMU_LOCK_S] old_index :%d;  next lock = %d, lock = %d[0:lock 1:unlock] \r\n", 3, old_index, vol, lock);
    }
    int i = 0;
    int temp = 0;
    int vol_index = 0;
    ...
    if (old_index < vol_index) { //rising
        ...
        log_hal_msgid_info("[PMU_BASIC]Same or higher requirements\r\n", 0);
        old_index = vol_index;
        hal_nvic_restore_interrupt_mask_special(mask_pri);
        if (pmu_dynamic_debug) {
            log_hal_msgid_info("[PMU_BASIC][PMU_LOCK_E] [vcore lock:%d][lock state : %d][ pmu_switch_case = %d][pmu_lock_status %d]", 4,
...
/*[VAUD18]*/
void pmu_set_vaud18_voltage_hp(pmu_vaud18_voltage_t oper)
{
    if (oper == PMU_VAUD18_1P8_V) {
        if (audio_mode == PMU_CLASSD) {
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL2, RG_BUCK_VAUD18_IPEAK_VTUNE_H_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_H_SHIFT, 0x1);
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_IPEAK_VTUNE_L_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_L_SHIFT, 0x4);
        } else {
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL2, RG_BUCK_VAUD18_IPEAK_VTUNE_H_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_H_SHIFT, 0x4);
        }
    } else {
        pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL2, RG_BUCK_VAUD18_IPEAK_VTUNE_H_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_H_SHIFT, 0x1);
        pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL3, RG_BUCK_VAUD18_IPEAK_VTUNE_M_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_M_SHIFT, 0x1);
        pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_IPEAK_VTUNE_L_MASK, RG_BUCK_VAUD18_IPEAK_VTUNE_L_SHIFT, 0x1);
    }
    switch (oper) {
        case PMU_VAUD18_0P7_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_VSEL_L_MASK, RG_BUCK_VAUD18_VSEL_L_SHIFT, 0x5);
            break;
        case PMU_VAUD18_0P8_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_VSEL_L_MASK, RG_BUCK_VAUD18_VSEL_L_SHIFT, 0xF);
            break;
        case PMU_VAUD18_0P9_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_VSEL_L_MASK, RG_BUCK_VAUD18_VSEL_L_SHIFT, 0x19);
            break;
        case PMU_VAUD18_1P2_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL3, RG_BUCK_VAUD18_VSEL_M_MASK, RG_BUCK_VAUD18_VSEL_M_SHIFT, 0x37);
            break;
        case PMU_VAUD18_1P3_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL3, RG_BUCK_VAUD18_VSEL_M_MASK, RG_BUCK_VAUD18_VSEL_M_SHIFT, 0x41);
            break;
        case PMU_VAUD18_1P77_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL2, RG_BUCK_VAUD18_VSEL_H_MASK, RG_BUCK_VAUD18_VSEL_H_SHIFT, 0x70);
            if (audio_mode == PMU_CLASSD) {
                pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL4, RG_BUCK_VAUD18_VSEL_L_MASK, RG_BUCK_VAUD18_VSEL_L_SHIFT, 0x70);
            }
            break;
        case PMU_VAUD18_1P8_V:
            pmu_set_register_value_hp(PMU_BUCK_VAUD18_CTRL2, RG_BUCK_VAUD18_VSEL_H_MASK, RG_BUCK_VAUD18_VSEL_H_SHIFT, 0x73);
            break;
    }
}
/*[VPA]*/
...
{
    if ((lv >= PMU_VAUD18_1P2_V) || (mv >= PMU_VAUD18_1P77_V) || (mv <= PMU_VAUD18_0P9_V) || (hv <= PMU_VAUD18_1P3_V)) {
        log_hal_msgid_info("[PMU_AUDIO]VAUD18 vol input error", 0);
        return PMU_INVALID;
    }
    log_hal_info("[PMU_AUDIO]VAUD18 vol before[%s][%s][%s]", vaud18_vsel_str[vaud18_vsel_arr[0]], vaud18_vsel_str[vaud18_vsel_arr[1]], vaud18_vsel_str[vaud18_vsel_arr[2]]);
    vaud18_vsel_arr[0] = lv;
    vaud18_vsel_arr[1] = mv;
    vaud18_vsel_arr[2] = hv;
    log_hal_info("[PMU_AUDIO]VAUD18 vol after[%s][%s][%s]", vaud18_vsel_str[vaud18_vsel_arr[0]], vaud18_vsel_str[vaud18_vsel_arr[1]], vaud18_vsel_str[vaud18_vsel_arr[2]]);
    return PMU_OK;
}
...
void pmu_set_audio_mode_init(pmu_audio_mode_t mode)
{
    ...
    switch (mode) {
        case PMU_CLASSAB:
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[2]);
            log_hal_msgid_info("[PMU_AUDIO] Audio mode = CLASS AB \r\n", 0);
            break;
        case PMU_CLASSG2:
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[0]);
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[2]);
            log_hal_msgid_info("[PMU_AUDIO] Audio mode = CLASS G2 \r\n", 0);
            break;
        case PMU_CLASSG3:
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[0]);
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[1]);
            pmu_set_vaud18_voltage_hp(vaud18_vsel_arr[2]);
            log_hal_msgid_info("[PMU_AUDIO] Audio mode = CLASS G3 \r\n", 0);
            break;
        case PMU_CLASSD:
            pmu_set_vaud18_voltage_hp(PMU_VAUD18_1P77_V);
...
{
    if (pmu_init_flag == 0) {
        pmu_set_register_value_hp(PMU_INT_CON0, 0xffff, 0, 0);
...
pmu_operate_status_t pmu_pk_filter(uint8_t pk_sta)
{
    if (pk_sta == 0) { //Press section : pk_next should be Press
        if (pk_next == PMU_PK_RELEASE && pmu_function_table[0].init_status != 0) {
            log_hal_msgid_info("[PMU_BASIC]PMIC INT[0]  [1]", 0);
            pmu_function_table[0].pmu_callback();
        }
        pk_next = PMU_PK_RELEASE;
        return PMU_OK;
    } else if (pk_sta == 1) { //Release section : pk_next should be Press
        if ((pk_first_boot_up == 1) && pk_next == PMU_PK_PRESS && pmu_function_table[0].init_status != 0) {
            log_hal_msgid_info("[PMU_BASIC]PMIC INT[0]  [0]", 0);
            pmu_function_table[0].pmu_callback();
        }
        pk_first_boot_up = 1; /*For first time boot up power key single*/
...
void pmu_dump_nvkey_hp(void)
{
    ...
    status = pmu_get_nvkey(addr, (uint8_t *)buffer_g, sizeof(buffer_g));
    if (status == PMU_STATUS_SUCCESS) {
        ...
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   PWRHOLD_Check[%d], VBUS debounce[%d]",
                           2, PMU_GET_U16(buffer_g, 0), PMU_GET_U16(buffer_g, 2)
                          );
    }

    addr = NVID_CAL_BAT_MGMT_BASIC;
    status = pmu_get_nvkey(addr, (uint8_t *)buffer_b, sizeof(buffer_b));
    if (status == PMU_STATUS_SUCCESS) {
        ...
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "fileld_0[%d], fileld_1[%d], fileld_2[%d], "
                           "fileld_3[%d], fileld_4[%d], fileld_5[%d]",
                           6,
                           PMU_GET_U16(buffer_b, 0), PMU_GET_U16(buffer_b, 2), PMU_GET_U16(buffer_b, 4),
                           PMU_GET_U16(buffer_b, 6), PMU_GET_U16(buffer_b, 8), PMU_GET_U16(buffer_b, 10)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "fileld_6[%d], fileld_7[%d], fileld_8[%d], "
                           "fileld_9[%d], fileld_10[%d], fileld_11[%d]",
                           8,
                           PMU_GET_U16(buffer_b, 12), PMU_GET_U16(buffer_b, 14), PMU_GET_U16(buffer_b, 16),
                           PMU_GET_U16(buffer_b, 18), PMU_GET_U16(buffer_b, 20), PMU_GET_U16(buffer_b, 22)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "fileld_6[%d], fileld_7[%d], fileld_8[%d], "
                           "fileld_9[%d], fileld_10[%d], fileld_11[%d]",
        ...
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           ...
                           4,
                           PMU_GET_U16(buffer_b, 24), PMU_GET_U16(buffer_b, 26),
                           PMU_GET_U16(buffer_b, 28), PMU_GET_U16(buffer_b, 30)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "recharge: volt[%d], adc[%d], offset_volt[%d], offset_adc[%d]",
                           4,
                           PMU_GET_U16(buffer_b, 32), PMU_GET_U16(buffer_b, 34),
                           PMU_GET_U16(buffer_b, 36), PMU_GET_U16(buffer_b, 38)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "PRECC CurrentSetting[%d], CV Termination Current[%d], "
                           "S1 volt[%d], multi lvl[%d], S2 volt[%d], multi lvl[%d]",
                           6,
                           PMU_GET_U16(buffer_b, 40), PMU_GET_U16(buffer_b, 42), PMU_GET_U16(buffer_b, 44),
                           PMU_GET_U16(buffer_b, 46), PMU_GET_U16(buffer_b, 48), PMU_GET_U16(buffer_b, 50)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "cool charger current[%d], cool cv flag[%d], "
                           "warm charger current[%d], warm cv flag[%d]",
                           4,
                           PMU_GET_U16(buffer_b, 52), PMU_GET_U16(buffer_b, 54),
                           PMU_GET_U16(buffer_b, 56), PMU_GET_U16(buffer_b, 58)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "iterm irq[%d], S0 voltage[%d], S0 current[%d], Batterycategory[%d]",
                           4,
                           PMU_GET_U16(buffer_b, 60), PMU_GET_U16(buffer_b, 62),
                           PMU_GET_U16(buffer_b, 64), PMU_GET_U16(buffer_b, 66)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   2-step: "
                           "Iterm_IRQ_1[%d], CV_1[%d], Iterm_IRQ_2[%d], CV_2[%d], "
                           "CV Enable[%d], CC Enable[%d]",
                           6,
                           PMU_GET_U16(buffer_b, 68), PMU_GET_U16(buffer_b, 70),
                           PMU_GET_U16(buffer_b, 72), PMU_GET_U16(buffer_b, 74),
                           PMU_GET_U16(buffer_b, 76), PMU_GET_U16(buffer_b, 78)
                          );
    }

    addr = NVID_CAL_BAT_MGMT_CHR;
    status = pmu_get_nvkey(addr, (uint8_t *)buffer_c, sizeof(buffer_c));
    if (status == PMU_STATUS_SUCCESS) {
        ...
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           ...
                           7,
                           PMU_GET_U16(buffer_c, 0), PMU_GET_U16(buffer_c, 1), PMU_GET_U16(buffer_c, 3),
                           PMU_GET_U16(buffer_c, 5), PMU_GET_U16(buffer_c, 7), PMU_GET_U16(buffer_c, 9), PMU_GET_U16(buffer_c, 11)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "chk1_volt[%d], chk1_adc[%d], chk2_volt[%d], chk2_adc[%d], chk3_volt[%d], chk3_adc[%d]",
                           6,
                           PMU_GET_U16(buffer_c, 13), PMU_GET_U16(buffer_c, 15),
                           PMU_GET_U16(buffer_c, 17), PMU_GET_U16(buffer_c, 19),
                           PMU_GET_U16(buffer_c, 21), PMU_GET_U16(buffer_c, 23)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "chk4_volt[%d], chk4_adc[%d], chk5_volt[%d], chk5_adc[%d], chk6_volt[%d], chk6_adc[%d]",
                           6,
                           PMU_GET_U16(buffer_c, 25), PMU_GET_U16(buffer_c, 27),
                           PMU_GET_U16(buffer_c, 29), PMU_GET_U16(buffer_c, 31),
                           PMU_GET_U16(buffer_c, 33), PMU_GET_U16(buffer_c, 35)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "chk7_volt[%d], chk7_adc[%d], chk8_volt[%d], chk8_adc[%d], chk9_volt[%d], chk9_adc[%d]",
                           6,
                           PMU_GET_U16(buffer_c, 37), PMU_GET_U16(buffer_c, 39),
                           PMU_GET_U16(buffer_c, 41), PMU_GET_U16(buffer_c, 43),
                           PMU_GET_U16(buffer_c, 45), PMU_GET_U16(buffer_c, 47)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "rsv1_volt[%d], rsv1_adc[%d]",
                           2,
                           PMU_GET_U16(buffer_c, 49), PMU_GET_U16(buffer_c, 51)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "Cold[%d], cool_cc[%d], COOL[%d], cool_cv[%d],",
                           4,
                           PMU_GET_U16(buffer_c, 53), PMU_GET_U16(buffer_c, 55),
                           PMU_GET_U16(buffer_c, 57), PMU_GET_U16(buffer_c, 59)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "WARM[%d], warm_cc[%d], HOT[%d], warm_cv[%d],",
                           4,
                           PMU_GET_U16(buffer_c, 61), PMU_GET_U16(buffer_c, 63),
                           PMU_GET_U16(buffer_c, 65), PMU_GET_U16(buffer_c, 67)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "rsv6[%d], rsv6_adc[%d], rsv7[%d], rsv7_adc[%d], "
                           "rsv8[%d], rsv8_adc[%d], rsv9[%d], rsv9_adc[%d]",
                           8,
                           PMU_GET_U16(buffer_c, 69), PMU_GET_U16(buffer_c, 71),
                           PMU_GET_U16(buffer_c, 73), PMU_GET_U16(buffer_c, 75),
                           PMU_GET_U16(buffer_c, 77), PMU_GET_U16(buffer_c, 79),
                           PMU_GET_U16(buffer_c, 81), PMU_GET_U16(buffer_c, 83)
                          );
    }

    addr = NVID_CAL_CHG_CTL_CFG;
    status = pmu_get_nvkey(addr, (uint8_t *)buffer_e, sizeof(buffer_e));
    if (status == PMU_STATUS_SUCCESS) {
        ...
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           ...
                           4,
                           PMU_GET_U16(buffer_e, 0), PMU_GET_U16(buffer_e, 2),
                           PMU_GET_U16(buffer_e, 4), PMU_GET_U16(buffer_e, 6)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   "
                           "PRECC timer EN[%d], PRECC safety time[%d], FASTCC timer EN[%d], FASTCC safety time[%d]",
                           4,
                           PMU_GET_U16(buffer_e, 8), PMU_GET_U16(buffer_e, 10),
                           PMU_GET_U16(buffer_e, 12), PMU_GET_U16(buffer_e, 14)
                          );
        log_hal_msgid_info("[PMU_CAL]pmu_dump_nvkey_hp,   Extend charging[%d]",
                           1, PMU_GET_U16(buffer_e, 16)
                          );
    }
}
...
void pmu_config_hp(void)
{
    ...
    log_hal_msgid_info("[PMU_CAL]pmu reset pattern hp, enable[%d], rst_pat[%d], cfg_en[%d], cfg[0x%x][0x%x][0x%x][0x%x]", 7,
                       rst_pat_cfg[0], rst_pat_cfg[1], rst_pat_cfg[2],
                       rst_pat_cfg[3], rst_pat_cfg[4], rst_pat_cfg[5], rst_pat_cfg[6]);
    if (rst_pat_cfg[0]) {
    ...
    if (rst_pat_cfg[2]) {
        pmu_set_register_value_hp(PMU_VBUS_UART_DIG0, RG_PAT_30MS_LL_LOW_MASK, RG_PAT_30MS_LL_LOW_SHIFT, rst_pat_cfg[3]);
        pmu_set_register_value_hp(PMU_VBUS_UART_DIG0, RG_PAT_30MS_LL_HGH_MASK, RG_PAT_30MS_LL_HGH_SHIFT, rst_pat_cfg[4]);
        pmu_set_register_value_hp(PMU_VBUS_UART_DIG0, RG_PAT_30MS_HH_LOW_MASK, RG_PAT_30MS_HH_LOW_SHIFT, rst_pat_cfg[5]);
        pmu_set_register_value_hp(PMU_VBUS_UART_DIG0, RG_PAT_30MS_HH_HGH_MASK, RG_PAT_30MS_HH_HGH_SHIFT, rst_pat_cfg[6]);
    }
#endif
}
