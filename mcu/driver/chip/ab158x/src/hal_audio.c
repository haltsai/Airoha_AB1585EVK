...
hal_audio_status_t hal_audio_get_stream_in_setting_config(audio_scenario_sel_t Audio_or_Voice, mcu2dsp_open_stream_in_param_t *stream_in_open_param)
{
...
#ifdef AIR_AUDIO_DETACHABLE_MIC_ENABLE
    if ((hal_audio_query_voice_mic_type() == VOICE_MIC_TYPE_DETACHABLE) && (Audio_or_Voice != AU_DSP_AUDIO) && (Audio_or_Voice != AU_DSP_ANC)) {
...
#endif
    {
        ...
        if (Audio_or_Voice == AU_DSP_VOICE) { //0:Audio, 1:Voice
            ...
            switch (hal_audio_convert_linein_config(audio_nvdm_HW_config.audio_scenario.Audio_Linein_Input_Path)) {
                case HAL_AUDIO_DEVICE_LINEINPLAYBACK_DUAL: //Line_In
                default:
                    stream_in_open_param->afe.audio_device  = HAL_AUDIO_DEVICE_LINEINPLAYBACK_L;
...
#ifdef AIR_AUDIO_SUPPORT_MULTIPLE_MICROPHONE
                    stream_in_open_param->afe.audio_device1 = HAL_AUDIO_DEVICE_LINEINPLAYBACK_R;
            stream_in_open_param->afe.audio_interface1 = stream_in_open_param->afe.audio_interface;
#endif
                    break;
                case HAL_AUDIO_DEVICE_I2S_MASTER: //I2S_Master_In
                    stream_in_open_param->afe.audio_device = HAL_AUDIO_DEVICE_I2S_MASTER_L;
                    stream_in_open_param->afe.audio_interface = 1 << (audio_nvdm_HW_config.audio_scenario.Audio_Linein_Input_I2S_Interface);
#ifdef AIR_AUDIO_SUPPORT_MULTIPLE_MICROPHONE
                    stream_in_open_param->afe.audio_device1 = HAL_AUDIO_DEVICE_I2S_MASTER_R;
                    stream_in_open_param->afe.audio_interface1 = 1 << (audio_nvdm_HW_config.audio_scenario.Audio_Linein_Input_I2S_Interface);
#endif
                    break;
            }
            //----LINE IN bias enable
