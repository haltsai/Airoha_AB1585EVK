...
hal_gpt_status_t hal_gpt_sw_start_timer_for_absolute_time_ms(uint32_t handle, hal_sw_gpt_absolute_parameter_t *absolute_parameter)
{
    return sw_gpt_start_timer_for_absolute_time(handle, absolute_parameter, SW_GPT_MS_TYPE);
}
hal_gpt_status_t hal_gpt_sw_start_timer_for_absolute_time_us(uint32_t handle, hal_sw_gpt_absolute_parameter_t *absolute_parameter)
{
    return sw_gpt_start_timer_for_absolute_time(handle, absolute_parameter, SW_GPT_US_TYPE);
}
