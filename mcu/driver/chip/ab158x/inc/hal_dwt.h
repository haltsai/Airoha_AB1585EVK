...
typedef enum { // now only suppuort for EMITRANGE=0, CYCMATCH = 0
    COMP_DISABLE = 0,
    WDE_INST = 2, // 0x0010: Generate PC watchpoint debug event whem instruction fetches
    WDE_DATA_RW = 4,  //    0x0100: Generate watchpoint debug event when read/write data accesses
