...
#ifdef AIR_BT_CODEC_BLE_ENABLED
#define SHARE_BUFFER_BLE_AUDIO_UL_SIZE     ((28+156)*6)
#define SHARE_BUFFER_BLE_AUDIO_DL_SIZE     ((28+156)*6)
...
#if defined(AIR_ECNR_1MIC_INEAR_ENABLE) || defined(AIR_ECNR_2MIC_INEAR_ENABLE) || (AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_BLE_AUDIO_DONGLE_ENABLE) || defined(AIR_3RD_PARTY_NR_ENABLE) || defined(AIR_ADAPTIVE_EQ_ENABLE)
