...
#define HAL_GPT_SW_US_PORT          HAL_GPT_4       /* configure HAL_GPT_4 as software timer for secure word */
#define HAL_CLOCK_CG_GPTIMER        HAL_CLOCK_CG_GPTIMER0
#else
#define GPT_IRQ_NUM                 GPT_IRQn
#define HAL_GPT_SW_US_PORT          HAL_GPT_4       /* configure HAL_GPT_4 as software timer for non-secure word */
#define HAL_CLOCK_CG_GPTIMER        HAL_CLOCK_CG_GPTIMER0
#endif 
...
#define HAL_GPT_SUPPORT_GPT_MAPPING     HAL_GPT_0,HAL_GPT_3,HAL_GPT_4,HAL_GPT_7   /* indicate the supported interrupt timer channle*/ 
