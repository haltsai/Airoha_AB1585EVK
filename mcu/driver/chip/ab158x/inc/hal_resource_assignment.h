...
#define HW_SYSRAM_PRIVATE_MEMORY_MUX_VAR_PORT_LEN 0x4F8
...
#define HW_SYSRAM_PRIVATE_MEMORY_LLMUX_VAR_PORT_LEN 0x328

#define HW_SYSRAM_PRIVATE_MEMORY_RESERVED_START (HW_SYSRAM_PRIVATE_MEMORY_LLMUX_VAR_PORT_START + HW_SYSRAM_PRIVATE_MEMORY_LLMUX_VAR_PORT_LEN)
...
#error Privite memory is used up
#endif
