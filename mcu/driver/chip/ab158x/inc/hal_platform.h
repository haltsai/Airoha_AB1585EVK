...
#define HAL_SECURITY_OTP_FEATURE_ENABLE
#define HAL_SECURITY_OTP_WRITE_FEATURE_ENABLE
#endif
...
typedef enum {
    ...
    AUDIO_POWER_DAC        = 17,                               /**< Audio Power for DAC */
    /* SPM STATE */
    AUDIO_DSP_SPM_STATE1   = 18,                               /**< Audio DSP Low power state1, dsp can't sleep */
    AUDIO_DSP_SPM_STATE3   = 19,                               /**< Audio DSP Low power state3, audio won't use, reserved */
    AUDIO_DSP_SPM_STATE4   = 20,                               /**< Audio DSP Low power state4, dsp can sleep */
    AUDIO_POWER_END        = 21,                               /**< Audio Power End Number */
...
/*************************************************************************
 * Defines available DVFS OPP, with CPU, DSP freqs commented at the end
 * Note: Use this as the 1st parameter when calling DVFS API hal_dvfs_lock_control()
*************************************************************************/

typedef enum {
    HAL_DVFS_OPP_LOW = 0, /* CM33 99.75MHz,   DSP 149.625MHz */
    HAL_DVFS_OPP_MID,     /* CM33 149.625MHz, DSP 299.25MHz */
    HAL_DVFS_OPP_HIGH,    /* CM33 260MHz,     DSP 520MHz */
    HAL_DVFS_OPP_NUM,
} dvfs_frequency_t;
#endif
