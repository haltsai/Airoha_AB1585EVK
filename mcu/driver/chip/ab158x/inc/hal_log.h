...
#elif defined(__EXT_DA__)
#define log_hal_error(_message,...)	DA_PRINTF(logging_level_error, _message, ##__VA_ARGS__)
#define log_hal_warning(_message,...)	DA_PRINTF(logging_level_warning, _message, ##__VA_ARGS__)
#define log_hal_info(_message,...)	DA_PRINTF(logging_level_info, _message, ##__VA_ARGS__)
#define log_hal_dump(_message, _data, _len, ...)

#define log_hal_msgid_error(_message,arg_cnt,...)	DA_PRINTF(logging_level_error, _message, ##__VA_ARGS__)
#define log_hal_msgid_warning(_message,arg_cnt,...)	DA_PRINTF(logging_level_warning, _message, ##__VA_ARGS__)
#define log_hal_msgid_info(_message,arg_cnt,...)	DA_PRINTF(logging_level_info, _message, ##__VA_ARGS__)
#define log_hal_msgid_dump(_message,arg_cnt, _data, _len, ...)
#else
