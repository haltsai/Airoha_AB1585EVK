...
typedef enum {
    BSP_LED_STATE_IDLE = 0,
    BSP_LED_STATE_T0,
    BSP_LED_STATE_T1T2_RPT,
    BSP_LED_STATE_T3,
    BSP_LED_STATE_MAX
} bsp_led_state_t;

typedef enum {
    BSP_LED_ACTION_OF_START,
    BSP_LED_ACTION_OF_TIMEOUT,
    BSP_LED_ACTION_OF_STOP,
    BSP_LED_ACTION_OF_CALI_TIMEOUT,
    BSP_LED_ACTION_MAX
} bsp_led_action_t;
...
typedef struct {
    ...
    bsp_led_state_t     cur_state;
    bsp_led_action_t    next_action;
    bool                req_cali;
    bsp_led_sw_cali_t   sw_cali;
    uint32_t            gpt_handle;
    uint32_t            t1t2_cycle;
