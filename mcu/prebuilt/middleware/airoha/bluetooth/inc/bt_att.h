 ...
 * @{
 * This section introduces the ATT operation codes, request and response structures, API prototypes
...
#define BT_ATT_ERRCODE_COMMON_PROCEDURE_IN_PROGRESS     0xFE        /**< Procedure Already in Progress. */
#define BT_ATT_ERRCODE_COMMON_OUT_OF_RANGE              0xFF        /**< Out of Range. */
...
#define BT_ATT_CLIENT_CHARC_CONFIG_NOTIFICATION  0x0001        /**< The Characteristic Value shall be notified.This value can only be set if the characteristic's properties have the notify bit set. */
#define BT_ATT_CLIENT_CHARC_CONFIG_INDICATION    0x0002        /**< The Characteristic Value shall be indicated. This value can only be set if the characteristic's properties have the indicate bit set. */
